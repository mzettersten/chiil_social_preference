var jsPsychHtmlButtonKeyboardResponse = (function (jspsych) {
  'use strict';

  var version = "2.1.0";

  const info = {
    name: "html-button-keyboard-response",
    version,
    parameters: {
  ...
  class HtmlButtonResponsePlugin {
    ...
    trial(display_element, trial) {
      ...
      stimulusElement.id = "jspsych-html-button-keyboard-response-stimulus";
      ...
      var after_response = (info2) => {
        display_element.querySelector("#jspsych-html-button-keyboard-response-stimulus").className += " responded";
      ...
      if (trial.response_keys != "NO_KEYS") {
    ...
    create_simulation_data(trial, simulation_options) {
      const default_data = {
        ...
        response: this.jsPsych.pluginAPI.getValidKey(trial.response_keys)
      };
